...
public class TurnLogGradeStats : MonoBehaviour
{
    ...
    // ===== Computed values (the ones GameOverEvaluator needs) =====
    ...
    // Token grammar: first part is ID, rest optional parentheses
    ...
    /// <summary>
    /// Call this whenever you enter the GameOver scene (eg. GameOverEvaluator.OnEnable).
    /// Always recomputes from the latest turnLog.
    /// </summary>
    public void Refresh()
    {
